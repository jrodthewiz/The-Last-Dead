...
const WEAPON_NAMES = ['PULSE REVOLVER', 'BREACH SHOTGUN', 'ARC LANCE'];
const WEAPON_HINTS = ['SEMI-AUTO // KEEP MOVING', 'CLOSE RANGE // WIDE SPREAD', 'RAIL PUNCH // PIERCE'];
    ...
    this.root.innerHTML = `<section class="screen menu-screen" aria-label="The Last Dead main menu">
      <div class="menu-shell">
        <div class="menu-copy">
          ...
          <div class="menu-copy-foot"><div class="menu-footer"><button class="text-button" type="button" data-action="settings">Settings</button><small class="build-revision">BUILD 04 / THE LAST DEAD</small></div><span class="menu-status">NO SAFE ROOM // SIGNAL OPEN</span></div>
        </div>
